...
|**Technique 3: Use an IFU**|Implements an IFU to handle PC incrementing and instruction/operand fetching in parallel with main execution, dramatically reducing path length.|
