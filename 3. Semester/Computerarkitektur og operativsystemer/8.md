...
So if $\alpha$ is 1 then you only rely on the most recent measurement and ignore the rest, if its 0 then you ignore the most recent measurement and only use the historical data, usually you just use $0.5$ if you don't have a good idea. 