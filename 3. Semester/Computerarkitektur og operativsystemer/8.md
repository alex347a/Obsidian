...
When scheduling is preemptive it means if it receives a shorter task after it started a long task, it will switch to the shorter task instead of sticking with the task it is doing at the moment.
