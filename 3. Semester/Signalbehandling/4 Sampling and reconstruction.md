...
$p(t)$ is an pulse sequence. T is the sampling period. n is the amount of samples. $*$ is not a star its just a $\cdot$ its NOT A CONVOLUTION. So you just take different points of the graph, you don't care how the graph actually looks between the dots.
