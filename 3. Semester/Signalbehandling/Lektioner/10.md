...
For a frequency normalized you can just make the cut-off frequency 1, which is just a prototype filter, and then later you can insert the specific frequency you want the cut-off frequency to be at. So you just substitute $s = s $