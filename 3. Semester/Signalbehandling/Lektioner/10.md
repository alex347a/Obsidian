...
As you can see the relationship is not linear, it is a tangential relationship. So first you map from the digital filter to the analogue filter and then you find the transfer func
