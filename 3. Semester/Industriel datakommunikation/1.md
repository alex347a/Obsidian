...
#### Packet switching
Packets are packages of information that are sent into junctions that send the packets in the right direction. The packets also have the advantage of being able to be sent at different places at.
