...
$$
$$
x_2 = a_1\cos(q_1) + a_2\cos(q_1+q_2), \quad
y_2 = a_1\sin(q_1) + a_2\sin(q_1+q_2)
$$
$$
x_3 = a_1\cos(q_1) + a_2\cos(q_1+q_2) + a_3\cos(q_1+q_2+q_3)
$$
$$
y_3 = a_1\sin(q_1) + a_2\sin(q_1+q_2) + a_3\sin(q_1+q_2+q_3)
$$

Da $z_{i-1} = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix}$, får vi for hvert led:
...
\times
\begin{bmatrix} x_3 \\ y_3 \\ 0 \end{bmatrix}
=
\begin{bmatrix} -y_3 \\ x_3 \\ 0 \end{bmatrix}
$$
Indsat med $a_i, q_i$:
$$
J_{P_1} =
\begin{bmatrix}
-(a_1\sin q_1 + a_2\sin(q_1+q_2) + a_3\sin(q_1+q_2+q_3))\\[4pt]
a_1\cos q_1 + a_2\cos(q_1+q_2) + a_3\cos(q_1+q_2+q_3)\\[4pt]
0
\end{bmatrix}
$$
...
\begin{bmatrix} x_3 \\ y_3 \\ 0 \end{bmatrix}
-
\begin{bmatrix} x_1 \\ y_1 \\ 0 \end{bmatrix}
\right)
=
\begin{bmatrix} -(y_3 - y_1) \\ x_3 - x_1 \\ 0 \end{bmatrix}
$$
Indsat:
$$
J_{P_2} =
\begin{bmatrix}
-(a_2\sin(q_1+q_2) + a_3\sin(q_1+q_2+q_3))\\[4pt]
a_2\cos(q_1+q_2) + a_3\cos(q_1+q_2+q_3)\\[4pt]
0
\end{bmatrix}
$$
...
\begin{bmatrix} x_3 \\ y_3 \\ 0 \end{bmatrix}
-
\begin{bmatrix} x_2 \\ y_2 \\ 0 \end{bmatrix}
\right)
=
\begin{bmatrix} -(y_3 - y_2) \\ x_3 - x_2 \\ 0 \end{bmatrix}
$$
Indsat:
$$
J_{P_3} =
\begin{bmatrix}
-\,a_3\sin(q_1+q_2+q_3)\\[4pt]
a_3\cos(q_1+q_2+q_3)\\[4pt]
0
\end{bmatrix}
$$
...
-(a_2\sin(q_1+q_2) + a_3\sin(q_1+q_2+q_3)) &
-\,a_3\sin(q_1+q_2+q_3) \\[6pt]
a_1\cos q_1 + a_2\cos(q_1+q_2) + a_3\cos(q_1+q_2+q_3) &
a_2\cos(q_1+q_2) + a_3\cos(q_1+q_2+q_3) &
a_3\cos(q_1+q_2+q_3) \\[6pt]
0 & 0 & 0 \\[4pt]
0 & 0 & 0 \\[4pt]
0 & 0 & 0 \\[4pt]
1 & 1 & 1
