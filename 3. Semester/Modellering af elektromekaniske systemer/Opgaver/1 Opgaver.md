...
Deler integralet op:
$$
X(\omega) = \frac{1}{2j} \int_{-\infty}^{\infty} e ^{j \omega_{0} t} e^{-j \omega t} \, dt - \frac{1}{2j} \int_{-\infty}^{\infty} e^{- j \omega_{0} t} e^{-j \omega t} \, dt
$$
