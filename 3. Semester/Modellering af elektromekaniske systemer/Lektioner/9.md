...
Husk at $\gamma = \frac{b}{m}$, jo mere vi dæmper, jo lavere en frekvens får vi, hvilket kan ses på $\omega_{d}$ som er dæmpnings-vinkelfrekvensen. Hvis dæmpningen er stor nok fås reelle rødder, hvis kvadratroden giver 0 så får man to rødder oveni hinanden, hvis dæmpningen er lav nok så er der komplekse rødder.
